...
type Props = {
  ...
  setOpenPromoCode: Dispatch<SetStateAction<boolean>>;
  addPromoCode: (level: PROMOCODE) => void;
};

export default function PromoCodeModal(props: Props) {
  const { openPromoCode, setOpenPromoCode, addPromoCode } = props;
  ...
  return (
    <Dialog open={openPromoCode} onOpenChange={setOpenPromoCode}>
      <DialogContent
